...
# Note: I've changed from three loops to one loop for simplicity.
# Also, accuracy was very hard to code because I'm not clear on how to define limits within the grid. Sorry about the confusion!
...
arugula1 = visual.ImageStim(
    win=win,
    name='arugula1', 
    image='stimuli/trial1s1/arugula.png', mask=None,
...
thicktriangle1 = visual.ImageStim(
    win=win,
    name='thicktriangle1', 
    image='stimuli/trial1s1/thicktriangle.png', mask=None,
...
thintriangle1 = visual.ImageStim(
    win=win,
    name='thintriangle1', 
    image='stimuli/trial1s1/thintriangle.png', mask=None,
...
fortunecookie1 = visual.ImageStim(
    win=win,
    name='fortunecookie1', 
    image='stimuli/trial1s1/fortunecookie.png', mask=None,
...
ducky1 = visual.ImageStim(
    win=win,
    name='ducky1', 
    image='stimuli/trial1s1/ducky.png', mask=None,
...
duckyhat1 = visual.ImageStim(
    win=win,
    name='duckyhat1', 
    image='stimuli/trial1s1/duckyhat.png', mask=None,
    ori=0, pos=(0.371, 0.26), size=(0.22, 0.22),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-7.0)
S1 = sound.Sound('stimuli/audio/triangle_S1.ogg', secs=-1, stereo=True, hamming=True,
    name='S1')
S1.setVolume(1)
...
grid2 = visual.ImageStim(
    win=win,
    name='grid2', 
    image='stimuli/trial1s2/grid.jpg', mask=None,
...
arugula2 = visual.ImageStim(
    win=win,
    name='arugula2', 
    image='stimuli/trial1s2/arugula.png', mask=None,
    ori=0, pos=(-0.124, -0.27), size=(0.24, 0.26),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-2.0)
thicktriangle2 = visual.ImageStim(
    win=win,
    name='thicktriangle2', 
    image='stimuli/trial1s2/thicktriangle.png', mask=None,
    ori=0, pos=(0.124, 0.01), size=(0.24, 0.22),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-3.0)
thintriangle2 = visual.ImageStim(
    win=win,
    name='thintriangle2', 
    image='stimuli/trial1s2/thintriangle.png', mask=None,
    ori=0, pos=(0.371, 0.01), size=(0.24, 0.22),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-4.0)
fortunecookie2 = visual.ImageStim(
    win=win,
    name='fortunecookie2', 
    image='stimuli/trial1s2/fortunecookie.png', mask=None,
    ori=0, pos=(-0.358, 0.26), size=(0.22, 0.22),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-5.0)
ducky2 = visual.ImageStim(
    win=win,
    name='ducky2', 
    image='stimuli/trial1s2/ducky.png', mask=None,
    ori=0, pos=(-.112, 0.26), size=(0.33, 0.33),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-6.0)
duckyhat2 = visual.ImageStim(
    win=win,
    name='duckyhat2', 
    image='stimuli/trial1s2/duckyhat.png', mask=None,
    ori=0, pos=(0.371, 0.26), size=(0.22, 0.22),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-7.0)
myPics = [thintriangle1, thintriangle2]
S2 = sound.Sound('stimuli/audio/triangle_S2.ogg', secs=-1, stereo=True, hamming=True,
    name='S2')
S2.setVolume(1)
...
grid1.setSize((1, .8))
grid1.setOri(0)
grid1.setImage('stimuli/trial1s1/grid.jpg')
# setup some python lists for storing info about the mouse
gotValidClick = False  # until a click is received
S1.setSound('stimuli/audio/triangle_S1.ogg', hamming=True)
...
text_2.setPos((0, -.3))
text_2.setText(msg)
text_2.setFont('Arial')
text_2.setHeight(0.1)
# keep track of which components have finished
sentence1Components = [grid1, mouse, arugula1, thicktriangle1, thintriangle1, fortunecookie1, ducky1, duckyhat1, S1, key_resp, text_2]
...
while continueRoutine:
    ...
    # *text_2* updates
    if text_2.status == NOT_STARTED and key_resp:
        # keep track of start time/frame for later
...
for thisTrial in trials:
    ...
    gotValidClick = False  # until a click is received
    S2.setSound('stimuli/audio/triangle_S2.ogg', hamming=True)
    ...
    if not key_resp.keys :
        ...
        msg="Oops! Try again."
    feedback2.setColor('black', colorSpace='rgb')
    feedback2.setPos((0, -.3))
    feedback2.setText(msg)
    feedback2.setFont('Arial')
    feedback2.setHeight(0.06)
    # keep track of which components have finished
    sentence2Components = [grid2, mouse_2, arugula2, thicktriangle2, thintriangle2, fortunecookie2, ducky2, duckyhat2, S2, key_resp_2, feedback2]
    ...
    while continueRoutine:
        ...
        # *feedback2* updates
        if feedback2.status == NOT_STARTED and key_resp_2:
            # keep track of start time/frame for later
...
if keys[0]=='space':
    ...
    trials.addData('feedback2.started', feedback2.tStartRefresh)
    trials.addData('feedback2.stopped', feedback2.tStopRefresh)
...
print('correct answers:',np.mean(correct))
